...
```bash
python3 skills/imf-ra-data/scripts/fetch_idata.py --db "<database_id>" --explore
```
...
```bash
python3 skills/imf-ra-data/scripts/fetch_idata.py --db "<database_id>" --dimension-values <DIM>
```
...
python3 skills/imf-ra-data/scripts/fetch_idata.py --db "<database_id>" --key "<dot.separated.key>" --start "<YYYY>" --end "<YYYY>" --format refreshable --indicator-dim "<dimension_name>"

# Wide (CSV by default; add --excel for Excel)
python3 skills/imf-ra-data/scripts/fetch_idata.py --db "<database_id>" --key "<dot.separated.key>" --start "<YYYY>" --end "<YYYY>" --format wide

# Long (CSV by default; add --excel for Excel)
python3 skills/imf-ra-data/scripts/fetch_idata.py --db "<database_id>" --key "<dot.separated.key>" --start "<YYYY>" --end "<YYYY>" --format long
```
...
```bash
# Refreshable
python3 skills/imf-ra-data/scripts/fetch_haver.py --codes "GDP@USECON" "UNRATE@USECON" --start "<YYYY>" --end "<YYYY>" --format refreshable --output <filename>.xlsx

# Wide (add --excel for .xlsx; default is .csv)
python3 skills/imf-ra-data/scripts/fetch_haver.py --codes "GDP@USECON" --start "<YYYY>" --end "<YYYY>" --format wide

# Long (add --excel for .xlsx; default is .csv)
python3 skills/imf-ra-data/scripts/fetch_haver.py --codes "GDP@USECON" --start "<YYYY>" --end "<YYYY>" --format long
```
